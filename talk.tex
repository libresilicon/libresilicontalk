...
\begin{frame}{Next}
	...
	\large{Victor and I}
	\begin{enumerate}
		\item Finish debugging all the features of 珠江芯片一号
		\item Create preliminary Verilog and Spice models
		\item Autogenerating standard cells with Hagens scripts
		\item Building ADCs and all the other analog stuff
		\item Build the North Point MCU (北角芯片)
		\item Build the Sau Mau Ping SoC (秀茂坪芯片)
	\end{enumerate}
	}
\end{frame}
